...
#define USER_DEFAULTS_FLOAT_PROPERTY(GETTER, SETTER) \
    USER_DEFAULTS_PROPERTY(CGFloat, floatForKey, setFloat, GETTER, SETTER)

#define USER_DEFAULTS_BOOL_PROPERTY(GETTER, SETTER) \
    USER_DEFAULTS_PROPERTY(BOOL, boolForKey, setBool, GETTER, SETTER)
